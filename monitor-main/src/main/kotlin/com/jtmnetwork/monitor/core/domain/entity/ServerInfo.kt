...
@Entity
@Table(name = "servers")
data class ServerInfo(@Id val id: String = "", val name: String, val version: String, val bukkitVersion: String, val minecraftVersion: String, val maxPlayers: Int, val port: Int, val viewDistance: Int, val created: Long = System.currentTimeMillis()) {
